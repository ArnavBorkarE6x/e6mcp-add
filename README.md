...
It will prompt for your cluster host, cluster name, e6 email, and PAT/password, then ask which client(s) to set up (default: **All**) and wire up the MCP server for you.
