...
It will prompt for your cluster host, e6 email, cluster name, and PAT/password, then ask which client(s) to set up (default: **All**) and wire up the MCP server for you.
